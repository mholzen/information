...
// CONSIDER: the Expected value could be a function that tests the actual value
// and returns a boolean indicating if it matches the actual value could be
// returned somehow, perhaps stored by that testing function
